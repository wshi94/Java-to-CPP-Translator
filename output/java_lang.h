...
namespace java {
    namespace lang {
        ...
        class NullPointerException : public RuntimeException {
            /*
                    public:
                        ...
                        static bool Check_Not_Null(void* o) {
        ...
        public:
            static bool Check_Not_Negative(int i){
                if(i<0){
        ...
        public:
            static bool check_legal_cast(Class source, Class destination) {

                // set parent class
                Class parent = source;

                // while top of inheritance hierarchy is not reached
                while(parent != (Class) __rt::null()) {
            ...
            /*
                public:
                static bool Check_Legal_Class(Class a, Class b){
                    bool legal=false;
                    while (b->getClass!=Object){
                        if( a==b){
                            legal=true;
                        }
                        b=b->getSuperclass;
